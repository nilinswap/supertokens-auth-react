...
exports.useOnMountAPICall = exports.getNormalisedUserContext = exports.setFrontendCookie = exports.getCookieValue = exports.getDefaultCookieScope = exports.normaliseCookieScopeOrThrowError = exports.mergeObjects = exports.removeFromLocalStorage = exports.setLocalStorage = exports.getLocalStorage = exports.getOriginOfPage = exports.isIE = exports.redirectWithHistory = exports.redirectWithFullPageReload = exports.matchRecipeIdUsingQueryParams = exports.appendQueryParamsToURL = exports.getCurrentNormalisedUrlPath = exports.validateForm = exports.normaliseInputAppInfoOrThrowError = exports.isTest = exports.getRedirectToPathFromURL = exports.getURLHash = exports.getQueryParams = exports.clearErrorQueryParam = exports.clearQueryParams = exports.getRecipeIdFromSearch = void 0;
...
function setLocalStorage(key, value) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.localStorage.setItem(key, value)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
...
function removeFromLocalStorage(key) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, windowHandler_1.WindowHandlerReference.getReferenceOrThrow().windowHandler.localStorage.removeItem(key)];
                case 1:
                    _a.sent();
                    return [2 /*return*/];
            }
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, cookieHandler_1.CookieHandlerReference.getReferenceOrThrow().cookieHandler.setCookie("".concat(name, "=").concat(cookieVal, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=lax"))];
                case 3:
                    _a.sent();
                    _a.label = 4;
                ...
                case 6:
                    _a.sent();
                    return [3 /*break*/, 9];
                case 7: return [4 /*yield*/, cookieHandler_1.CookieHandlerReference.getReferenceOrThrow().cookieHandler.setCookie("".concat(name, "=").concat(cookieVal, ";domain=").concat(scope, ";expires=Fri, 31 Dec 9999 23:59:59 GMT;path=/;samesite=lax"))];
                case 8:
                    _a.sent();
                    _a.label = 9;
