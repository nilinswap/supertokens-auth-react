...
var SuperTokens = /** @class */ (function () {
    ...
    function SuperTokens(config) {
        ...
        this.canHandleRoute = function () {
            return _this.getMatchingComponentForRouteAndRecipeId((0, utils_1.getCurrentNormalisedUrlPath)()) !== undefined;
        };
        this.getRoutingComponent = function () {
            return ((0, jsx_runtime_1.jsx)(routingComponent_1.RoutingComponent, { path: (0, utils_1.getCurrentNormalisedUrlPath)().getAsStringDangerous(), supertokensInstance: _this }));
        };
        ...
        this.changeLanguage = function (lang) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, (0, translationHelpers_1.saveCurrentLanguage)(lang, this.languageTranslations.currentLanguageCookieScope)];
                    case 1:
                        _a.sent();
    ...
    SuperTokens.getSuperTokensRoutesForReactRouterDom = function (reactRouterDom) {
        ...
        if (SuperTokens.reactRouterDomIsV6) {
            ...
            var useNavigateHookForRRDV6 = function () {
                ...
                var _a = React.useState(undefined), to = _a[0], setTo = _a[1];
