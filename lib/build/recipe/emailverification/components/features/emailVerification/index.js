...
var EmailVerification = function (props) {
    ...
    var modifiedRecipeImplementation = (0, react_1.useMemo)(function () { return (__assign(__assign({}, props.recipe.recipeImpl), { sendVerificationEmail: function (input) { return __awaiter(void 0, void 0, void 0, function () {
            var response;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, props.recipe.recipeImpl.sendVerificationEmail(input)];
                    case 1:
                        response = _a.sent();
    ...
    var fetchIsEmailVerified = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var token;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                case 0:
                    ...
                    token = (_a = (0, utils_1.getQueryParams)("token")) !== null && _a !== void 0 ? _a : undefined;
                ...
                case 1:
                    _b.sent();
                    return [3 /*break*/, 4];
                case 2: return [4 /*yield*/, props.recipe.recipeImpl.isEmailVerified({ userContext: userContext })];
                case 3: 
    ...
    var checkIsEmailVerified = (0, react_1.useCallback)(function (isVerified) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            if (isVerified) {
    ...
    (0, utils_1.useOnMountAPICall)(fetchIsEmailVerified, checkIsEmailVerified, undefined, sessionContext.loading === false);
    var signOut = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, props.recipe.config.signOut()];
                case 1:
                    _a.sent();
                    return [4 /*yield*/, props.recipe.config.redirectToSignIn(props.history)];
    ...
    var onTokenInvalidRedirect = (0, react_1.useCallback)(function () { return props.recipe.config.redirectToSignIn(props.history); }, [props.recipe, props.history]);
    var onSuccess = (0, react_1.useCallback)(function () { return props.recipe.config.postVerificationRedirect(props.history); }, [props.recipe, props.history]);
    if (status === "LOADING") {
    ...
    return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: componentOverrides }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsEmailVerification }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [props.children === undefined && (0, jsx_runtime_1.jsx)(emailVerification_1.EmailVerificationTheme, __assign({}, childProps)), props.children &&
