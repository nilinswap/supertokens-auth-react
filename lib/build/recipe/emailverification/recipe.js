...
var EmailVerification = /** @class */ (function (_super) {
    ...
    function EmailVerification(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.mode !== "OFF" && _this.config.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    component: function (props) { return _this.getFeatureComponent("emailverification", props); },
                };
            }
            return features;
        };
        ...
        _this.getFeatureComponent = function (_, props) {
            return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(session_1.SessionAuth, __assign({ requireAuth: false }, { children: (0, jsx_runtime_1.jsx)(usercontext_1.UserContextContext.Consumer, { children: function (value) {
                            return ((0, jsx_runtime_1.jsx)(emailVerification_1.default, __assign({ recipe: _this }, __assign(__assign({}, props), { 
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (context.action === "VERIFY_EMAIL") {
                    ...
                    return [2 /*return*/, "".concat(this.config.appInfo.websiteBasePath.appendPath(verifyEmailPath).getAsStringDangerous(), "?rid=").concat(this.config.recipeId)];
                }
                else {
                    return [2 /*return*/, "/"];
                }
    ...
    EmailVerification.init = function (config) {
        return function (appInfo) {
            EmailVerification.instance = new EmailVerification(__assign(__assign({}, config), { appInfo: appInfo, recipeId: EmailVerification.RECIPE_ID }));
    ...
    EmailVerification.prototype.isEmailVerified = function (userContext) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.recipeImpl.isEmailVerified({
