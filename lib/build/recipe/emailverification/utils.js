...
function normaliseEmailVerificationFeature(config) {
    ...
    return __assign(__assign({}, (0, utils_1.normaliseRecipeModuleConfig)(config)), { disableDefaultUI: disableDefaultUI, mode: mode, sendVerifyEmailScreen: sendVerifyEmailScreen, verifyEmailLinkClickedScreen: verifyEmailLinkClickedScreen, signOut: config.signOut, postVerificationRedirect: config.postVerificationRedirect, redirectToSignIn: config.redirectToSignIn, override: override });
}
