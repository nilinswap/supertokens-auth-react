...
var EmailVerificationAuth = function (_a) {
    ...
    var _b = (0, react_1.useState)(false), isEmailVerified = _b[0], setIsEmailVerified = _b[1];
    ...
    var checkIsEmailVerified = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    if (!(sessionContext.doesSessionExist && recipe.current.config.mode === "REQUIRED")) return [3 /*break*/, 2];
                    return [4 /*yield*/, recipe.current.isEmailVerified(userContext)];
                case 1: return [2 /*return*/, (_a.sent()).isVerified];
                case 2: return [2 /*return*/, undefined];
            }
        });
    }); }, [sessionContext]);
    var useIsEmailVerified = (0, react_1.useCallback)(function (isEmailVerified) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (sessionContext.loading === true) {
                    ...
                    if (!(sessionContext.doesSessionExist && recipe.current.config.mode === "REQUIRED")) return [3 /*break*/, 3];
                    if (!(isEmailVerified === false)) return [3 /*break*/, 2];
                    return [4 /*yield*/, recipe.current.redirect({ action: "VERIFY_EMAIL" }, propsRef.current.history)];
                case 1:
                    _a.sent();
                    return [3 /*break*/, 3];
                case 2:
    ...
    (0, utils_1.useOnMountAPICall)(checkIsEmailVerified, useIsEmailVerified, undefined, sessionContext.loading === false);
...
var EmailVerificationAuthWrapper = function (props) {
    return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(EmailVerificationAuth, __assign({}, props)) })));
};
