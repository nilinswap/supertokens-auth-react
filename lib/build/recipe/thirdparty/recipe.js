...
var ThirdParty = /** @class */ (function (_super) {
    ...
    function ThirdParty(config, recipes) {
        var _this = _super.call(this, (0, utils_2.normaliseThirdPartyConfig)(config), {
        ...
        _this.getFeatures = function () {
            ...
            _this.config.signInAndUpFeature.providers.forEach(function (provider) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default("/callback/".concat(provider.id)));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: function () { return (0, utils_2.matchRecipeIdUsingState)(_this, {}); },
                    component: function (prop) { return _this.getFeatureComponent("signinupcallback", prop); },
                };
            });
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(signInAndUpCallback_1.default, __assign({ recipe: _this }, props)) })));
            }
            else {
    ...
    ThirdParty.init = function (config) {
        return function (appInfo) {
            ThirdParty.instance = new ThirdParty(__assign(__assign({}, config), { appInfo: appInfo, recipeId: ThirdParty.RECIPE_ID }), {
