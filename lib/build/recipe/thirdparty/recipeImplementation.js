    ...
    return {
        getAuthorisationURLFromBackend: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, webJsImplementation.getAuthorisationURLFromBackend.bind(this)({
        ...
        signInAndUp: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, webJsImplementation.signInAndUp.bind(this)({
                                userContext: input.userContext,
                            })];
                        case 1:
                            response = _a.sent();
        ...
        setStateAndOtherInfoToStorage: function (input) {
            return webJsImplementation.setStateAndOtherInfoToStorage.bind(this)({
                state: __assign(__assign({}, input.state), { rid: recipeInput.recipeId, redirectToPath: (0, utils_1.getRedirectToPathFromURL)() }),
                userContext: input.userContext,
            });
        },
        getAuthorisationURLWithQueryParamsAndSetState: function (input) {
            return __awaiter(this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    return [2 /*return*/, webJsImplementation.getAuthorisationURLWithQueryParamsAndSetState.bind(this)(__assign({}, input))];
                });
            });
        },
