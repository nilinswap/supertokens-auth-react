...
function useChildProps(recipe) {
    ...
    return (0, react_2.useMemo)(function () {
        ...
        var providers = recipe.config.signInAndUpFeature.providers.map(function (provider) { return ({
            id: provider.id,
