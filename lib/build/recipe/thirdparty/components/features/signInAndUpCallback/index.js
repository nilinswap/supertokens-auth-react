...
var SignInAndUpCallback = function (props) {
    ...
    var verifyCode = (0, react_1.useCallback)(function () {
        return props.recipe.recipeImpl.signInAndUp({
            userContext: userContext,
        });
    }, [props.recipe, props.history]);
    var handleVerifyResponse = (0, react_1.useCallback)(function (response) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, props.recipe.savePostEmailVerificationSuccessRedirectState({
                ...
                case 5:
                    _a.sent();
                    return [2 /*return*/, props.recipe.emailVerification.redirect({
                            action: "VERIFY_EMAIL",
                        }, props.history)];
                case 6: return [2 /*return*/, props.recipe.redirect({ action: "SUCCESS", isNewUser: response.createdNewUser, redirectToPath: redirectToPath }, props.history)];
    ...
    return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: componentOverrides }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsThirdParty }, { children: (0, jsx_runtime_1.jsx)(styleContext_1.StyleProvider, __assign({ rawPalette: props.recipe.config.palette, defaultPalette: styles_1.defaultPalette, styleFromInit: oAuthCallbackScreen.style, rootStyleFromInit: props.recipe.config.rootStyle, getDefaultStyles: styles_2.getStyles }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [props.children === undefined && (0, jsx_runtime_1.jsx)(signInAndUpCallback_1.SignInAndUpCallbackTheme, {}), props.children] }) })) })) })));
};
