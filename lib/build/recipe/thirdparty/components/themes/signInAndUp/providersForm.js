...
var ThirdPartySignInAndUpProvidersForm = function (props) {
    ...
    var signInClick = function (providerId) { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, utils_1.redirectToThirdPartyLogin)({
    ...
    return ((0, jsx_runtime_1.jsx)(react_1.Fragment, { children: props.providers.map(function (provider) {
            return ((0, jsx_runtime_1.jsx)("div", __assign({ css: styles.providerContainer, "data-supertokens": "providerContainer" }, { children: (0, jsx_runtime_1.jsx)("span", __assign({ onClick: function () { return signInClick(provider.id); } }, { children: provider.buttonComponent })) }), "provider-".concat(provider.id)));
        }) }));
};
exports.ThirdPartySignInAndUpProvidersForm = ThirdPartySignInAndUpProvidersForm;
exports.ProvidersForm = (0, withOverride_1.withOverride)("ThirdPartySignInAndUpProvidersForm", exports.ThirdPartySignInAndUpProvidersForm);
