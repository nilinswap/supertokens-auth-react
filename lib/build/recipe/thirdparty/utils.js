...
exports.redirectToThirdPartyLogin = exports.matchRecipeIdUsingState = exports.normaliseSignInAndUpFeature = exports.normaliseThirdPartyConfig = void 0;
/*
 * Imports.
 */
...
function normaliseThirdPartyConfig(config) {
    ...
    return __assign(__assign({}, (0, utils_1.normaliseAuthRecipeWithEmailVerificationConfig)(config)), { signInAndUpFeature: signInAndUpFeature, oAuthCallbackScreen: oAuthCallbackScreen, override: override });
}
...
function redirectToThirdPartyLogin(input) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    provider = input.config.signInAndUpFeature.providers.find(function (p) { return p.id === input.thirdPartyId; });
