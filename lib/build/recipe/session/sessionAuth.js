...
var SessionAuth = function (_a) {
    ...
    var _b = (0, react_1.useState)(!(0, sessionContext_1.isDefaultContext)(parentSessionContext) ? parentSessionContext : { loading: true }), context = _b[0], setContext = _b[1];
    var session = (0, react_1.useRef)();
    var userContext = (0, usercontext_1.useUserContext)();
    var buildContext = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        var sessionExists;
        var _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 3: return [2 /*return*/, (_a.userId = _b.sent(),
                        _a.loading = false,
                        _a)];
            }
        });
    }); }, []);
    var setInitialContextAndMaybeRedirect = (0, react_1.useCallback)(function (toSetContext) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(this, function (_a) {
            ...
            if (!toSetContext.doesSessionExist && props.requireAuth === true) {
                ...
                setContext(function (context) { return (!context.loading ? context : toSetContext); });
            }
            return [2 /*return*/];
        });
    ...
    return (0, jsx_runtime_1.jsx)(sessionContext_1.default.Provider, __assign({ value: __assign(__assign({}, actualContext), { isDefault: false }) }, { children: children }));
};
var SessionAuthWrapper = function (props) {
    return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(SessionAuth, __assign({}, props)) })));
};
