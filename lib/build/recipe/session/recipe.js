...
var Session = /** @class */ (function (_super) {
    ...
    function Session(config) {
        ...
        _this.notifyListeners = function (event) { return __awaiter(_this, void 0, void 0, function () {
            var sessionContext;
            return __generator(this, function (_a) {
                switch (_a.label) {
        ...
        _this.webJsRecipe = new recipe_1.Recipe(__assign(__assign({}, config), { onHandleEvent: function (event) {
                ...
                var response;
                return __generator(this, function (_a) {
                    response = __assign(__assign({}, context), { requestInit: __assign(__assign({}, context.requestInit), { headers: __assign(__assign({}, context.requestInit.headers), { rid: config.recipeId }) }) });
    ...
    Session.prototype.getSessionContext = function (_a) {
        ...
        return __awaiter(this, void 0, void 0, function () {
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        if (!(action === "SESSION_CREATED" || action === "REFRESH_SESSION" || action === "ACCESS_TOKEN_PAYLOAD_UPDATED")) return [3 /*break*/, 2];
    ...
    Session.init = function (config) {
        return function (appInfo, enableDebugLogs) {
            Session.instance = new Session(__assign(__assign({}, config), { appInfo: appInfo, recipeId: Session.RECIPE_ID, enableDebugLogs: enableDebugLogs }));
