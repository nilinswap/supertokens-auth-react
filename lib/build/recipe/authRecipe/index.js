...
var AuthRecipe = /** @class */ (function (_super) {
    ...
    function AuthRecipe(config) {
        ...
        _this.getAuthRecipeDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
        ...
        _this.doesSessionExist = function (input) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, recipe_1.default.getInstanceOrThrow().doesSessionExist({
                            userContext: (0, utils_1.getNormalisedUserContext)(input === null || input === void 0 ? void 0 : input.userContext),
                        })];
                    case 1: return [2 /*return*/, _a.sent()];
                }
