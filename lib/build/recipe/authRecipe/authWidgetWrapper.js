...
var AuthWidgetWrapper = function (props) {
    return ((0, jsx_runtime_1.jsx)(session_1.SessionAuth, __assign({ requireAuth: false }, { children: (0, jsx_runtime_1.jsx)(Redirector, __assign({}, props)) })));
};
var Redirector = function (props) {
    var sessionContext = (0, react_1.useContext)(session_1.SessionContext);
    var _a = (0, react_1.useState)(false), alwaysShow = _a[0], updateAlwaysShow = _a[1];
