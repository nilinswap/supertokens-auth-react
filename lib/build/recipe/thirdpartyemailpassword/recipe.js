...
var ThirdPartyEmailPassword = /** @class */ (function (_super) {
    ...
    function ThirdPartyEmailPassword(config, recipes) {
        var _this = _super.call(this, (0, utils_2.normaliseThirdPartyEmailPasswordConfig)(config), {
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                if (_this.thirdPartyRecipe === undefined) {
                    throw new Error("Embedding this component requires the thirdparty recipe to be enabled. Please check the value of signInAndUpFeature.providers in the configuration.");
                }
    ...
    ThirdPartyEmailPassword.init = function (config) {
        return function (appInfo) {
            ThirdPartyEmailPassword.instance = new ThirdPartyEmailPassword(__assign(__assign({}, config), { appInfo: appInfo, recipeId: ThirdPartyEmailPassword.RECIPE_ID }), {
