...
var Passwordless = /** @class */ (function (_super) {
    ...
    function Passwordless(config) {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.linkClickedScreenFeature.disableDefaultUI !== true) {
                var normalisedFullPath = _this.config.appInfo.websiteBasePath.appendPath(new normalisedURLPath_1.default("/verify"));
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: (0, utils_1.matchRecipeIdUsingQueryParams)(_this.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("linkClickedScreen", props); },
                };
            }
            return features;
        };
        ...
        _this.getFeatureComponent = function (componentName, props) {
            ...
            if (componentName === "linkClickedScreen") {
                return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(linkClickedScreen_1.default, __assign({ recipe: _this }, props)) })));
            }
    ...
    Passwordless.init = function (config) {
        return function (appInfo) {
            Passwordless.instance = new Passwordless(__assign(__assign({}, config), { appInfo: appInfo, recipeId: Passwordless.RECIPE_ID }));
