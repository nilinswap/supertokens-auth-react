...
exports.SignInUpFeature = exports.useChildProps = exports.useFeatureReducer = exports.useSuccessInAnotherTabChecker = void 0;
...
var useSuccessInAnotherTabChecker = function (state, dispatch, userContext) {
    ...
    (0, react_4.useEffect)(function () {
        ...
        if (state.loginAttemptInfo && !state.successInAnotherTab) {
            var checkSessionIntervalHandle_1 = setInterval(function () { return __awaiter(void 0, void 0, void 0, function () {
                var hasSession;
...
var useFeatureReducer = function (recipeImpl, userContext) {
    var _a = React.useReducer(function (oldState, action) {
        switch (action.type) {
            ...
            case "startLogin":
                return __assign(__assign({}, oldState), { loginAttemptInfo: action.loginAttemptInfo, error: undefined });
...
function useChildProps(recipe, dispatch, state, callingConsumeCodeRef, history) {
    var recipeImplementation = React.useMemo(function () { return recipe && getModifiedRecipeImplementation(recipe.recipeImpl, dispatch, callingConsumeCodeRef); }, [recipe]);
        ...
        return {
            onSuccess: function (result) {
                ...
                return recipe.redirect({
                    ...
                    redirectToPath: pathFromUrl !== undefined ? pathFromUrl : (_a = state.loginAttemptInfo) === null || _a === void 0 ? void 0 : _a.redirectToPath,
                }, history);
            },
...
var SignInUpFeature = function (props) {
    ...
    var _a = (0, exports.useFeatureReducer)(props.recipe.recipeImpl, userContext), state = _a[0], dispatch = _a[1];
    ...
    return __assign(__assign({}, originalImpl), { createCode: function (input) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        ...
                        return [4 /*yield*/, (0, utils_2.setLoginAttemptInfo)({
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 2:
                        loginAttemptInfo = _a.sent();
                        if (!(loginAttemptInfo !== undefined && loginAttemptInfo.deviceId === input.deviceId)) return [3 /*break*/, 4];
                        timestamp = Date.now();
                        return [4 /*yield*/, (0, utils_2.setLoginAttemptInfo)({
                                recipeImplementation: originalImpl,
                                userContext: input.userContext,
