...
var LinkClickedScreen = function (props) {
    ...
    var _a = (0, react_2.useState)(false), requireUserInteraction = _a[0], setRequireUserInteraction = _a[1];
    var consumeCodeAtMount = (0, react_2.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    ...
                    return [4 /*yield*/, props.recipe.redirectToAuthWithoutRedirectToPath(undefined, props.history, {
                            error: "signin",
                        })];
                case 1:
                    _a.sent();
                    return [2 /*return*/, "REDIRECTING"];
                case 2: return [4 /*yield*/, props.recipe.recipeImpl.getLoginAttemptInfo({ userContext: userContext })];
                case 3:
                    ...
                    return [2 /*return*/, props.recipe.recipeImpl.consumeCode({
    ...
    var handleConsumeResp = (0, react_2.useCallback)(function (response) { return __awaiter(void 0, void 0, void 0, function () {
            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (response.status === "RESTART_FLOW_ERROR") {
                        return [2 /*return*/, props.recipe.redirectToAuthWithoutRedirectToPath(undefined, props.history, {
                                error: "restart_link",
                            })];
                    }
                    if (!(response.status === "OK")) return [3 /*break*/, 3];
                    return [4 /*yield*/, (0, utils_2.getLoginAttemptInfo)({
    ...
    var handleConsumeError = (0, react_2.useCallback)(function (err) {
        ...
        consumeCode: function () { return __awaiter(void 0, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 1:
                        _a.trys.push([1, 4, , 5]);
                        return [4 /*yield*/, props.recipe.recipeImpl.consumeCode({
                                preAuthSessionId: preAuthSessionId,
                                linkCode: linkCode,
                                userContext: userContext,
                            })];
    ...
    return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: componentOverrides }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsPasswordless }, { children: (0, jsx_runtime_1.jsx)(styleContext_1.StyleProvider, __assign({ rawPalette: props.recipe.config.palette, defaultPalette: styles_1.defaultPalette, styleFromInit: linkClickedScreen.style, rootStyleFromInit: props.recipe.config.rootStyle, getDefaultStyles: styles_2.getStyles }, { children: (0, jsx_runtime_1.jsxs)(react_2.Fragment, { children: [props.children === undefined && (0, jsx_runtime_1.jsx)(linkClickedScreen_1.LinkClickedScreen, __assign({}, childProps)), props.children &&
