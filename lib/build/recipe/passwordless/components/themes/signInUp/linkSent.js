...
var PasswordlessLinkSent = function (props) {
    ...
    var _a = (0, react_1.useState)(props.error !== undefined ? "ERROR" : "READY"), status = _a[0], setStatus = _a[1];
    ...
    var resendEmail = (0, react_1.useCallback)(function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return ((0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "container", css: styles.container }, { children: (0, jsx_runtime_1.jsxs)("div", __assign({ "data-supertokens": "row", css: styles.row }, { children: [status === "ERROR" && ((0, jsx_runtime_1.jsx)(generalError_1.default, { error: props.error === undefined ? "SOMETHING_WENT_WRONG_ERROR" : props.error })), resendActive && ((0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "generalSuccess", css: styles.generalSuccess }, { children: t("PWLESS_LINK_SENT_RESEND_SUCCESS") }))), (0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "sendCodeIcon", css: styles.sendCodeIcon }, { children: props.loginAttemptInfo.contactMethod === "EMAIL" ? (0, jsx_runtime_1.jsx)(emailLargeIcon_1.default, {}) : (0, jsx_runtime_1.jsx)(smsLargeIcon_1.default, {}) })), (0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "headerTitle headerTinyTitle", css: [styles.headerTitle, styles.headerTinyTitle] }, { children: t("PWLESS_LINK_SENT_RESEND_TITLE") })), (0, jsx_runtime_1.jsxs)("div", __assign({ "data-supertokens": "primaryText sendCodeText", css: [styles.primaryText, styles.sendCodeText] }, { children: [props.loginAttemptInfo.contactMethod === "EMAIL"
                            ? t("PWLESS_LINK_SENT_RESEND_DESC_START_EMAIL")
                            : t("PWLESS_LINK_SENT_RESEND_DESC_START_PHONE"), (0, jsx_runtime_1.jsx)("strong", { children: props.loginAttemptInfo.contactInfo }), props.loginAttemptInfo.contactMethod === "EMAIL"
                            ? t("PWLESS_LINK_SENT_RESEND_DESC_END_EMAIL")
                            : t("PWLESS_LINK_SENT_RESEND_DESC_END_PHONE")] })), (0, jsx_runtime_1.jsx)(resendButton_1.ResendButton, { loginAttemptInfo: props.loginAttemptInfo, resendEmailOrSMSGapInSeconds: props.config.signInUpFeature.resendEmailOrSMSGapInSeconds, onClick: resendEmail }), (0, jsx_runtime_1.jsxs)("div", __assign({ "data-supertokens": "secondaryText secondaryLinkWithLeftArrow", css: [styles.secondaryText, styles.secondaryLinkWithLeftArrow], onClick: function () {
                        return props.recipeImplementation.clearLoginAttemptInfo({
                            userContext: userContext,
                        });
                    } }, { children: [(0, jsx_runtime_1.jsx)(arrowLeftIcon_1.default, { color: styles.palette.colors.textPrimary }), props.loginAttemptInfo.contactMethod === "EMAIL"
...
//# sourceMappingURL=linkSent.js.map