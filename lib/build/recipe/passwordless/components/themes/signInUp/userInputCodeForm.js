...
exports.UserInputCodeForm = (0, withOverride_1.withOverride)("PasswordlessUserInputCodeForm", function PasswordlessUserInputCodeForm(props) {
    var _this = this;
    ...
    var _a = (0, react_1.useState)(), clearResendNotifTimeout = _a[0], setClearResendNotifTimeout = _a[1];
    ...
    return ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [clearResendNotifTimeout !== undefined && ((0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "generalSuccess", css: [styles.generalSuccess] }, { children: props.loginAttemptInfo.contactMethod === "EMAIL"
                    ? t("PWLESS_RESEND_SUCCESS_EMAIL")
                    : t("PWLESS_RESEND_SUCCESS_PHONE") }))), (0, jsx_runtime_1.jsx)(formBase_1.default, { clearError: props.clearError, onError: props.onError, formFields: [
                    {
                        id: "userInputCode",
                        label: "",
                        labelComponent: ((0, jsx_runtime_1.jsxs)("div", __assign({ css: styles.codeInputLabelWrapper, "data-supertokens": "codeInputLabelWrapper" }, { children: [(0, jsx_runtime_1.jsx)(library_1.Label, { value: "PWLESS_USER_INPUT_CODE_INPUT_LABEL", "data-supertokens": "codeInputLabel" }), (0, jsx_runtime_1.jsx)(resendButton_1.ResendButton, { loginAttemptInfo: props.loginAttemptInfo, resendEmailOrSMSGapInSeconds: props.config.signInUpFeature.resendEmailOrSMSGapInSeconds, onClick: resend })] }))),
                        autofocus: true,
                        optional: false,
                        clearOnSubmit: true,
                        placeholder: "",
                ...
                ], onSuccess: props.onSuccess, buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", callAPI: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
                ...
                }); }, validateOnBlur: false, showLabels: true, footer: (0, jsx_runtime_1.jsx)(userInputCodeFormFooter_1.UserInputCodeFormFooter, __assign({}, props, { loginAttemptInfo: props.loginAttemptInfo })) })] }));
});
//# sourceMappingURL=userInputCodeForm.js.map