...
exports.PhoneForm = (0, withOverride_1.withOverride)("PasswordlessPhoneForm", function PasswordlessPhoneForm(props) {
    ...
    var phoneInput = (0, react_1.useMemo)(function () {
    ...
    return ((0, jsx_runtime_1.jsx)(formBase_1.default, { clearError: props.clearError, onError: props.onError, formFields: [
        ...
        ], buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields) { return __awaiter(_this, void 0, void 0, function () {
