...
exports.EmailOrPhoneForm = (0, withOverride_1.withOverride)("PasswordlessEmailOrPhoneForm", function PasswordlessEmailOrPhoneForm(props) {
    var _this = this;
    var _a = (0, react_1.useState)(false), isPhoneNumber = _a[0], setIsPhoneNumber = _a[1];
    var userContext = (0, usercontext_1.useUserContext)();
    var emailOrPhoneInput = (0, react_1.useMemo)(function () {
    ...
    return ((0, jsx_runtime_1.jsx)(formBase_1.default, { clearError: props.clearError, onError: props.onError, formFields: [
            {
                id: "emailOrPhone",
        ...
        ], buttonLabel: "PWLESS_SIGN_IN_UP_CONTINUE_BUTTON", onSuccess: props.onSuccess, callAPI: function (formFields, setValue) { return __awaiter(_this, void 0, void 0, function () {
            var emailOrPhone, emailValidationRes, response, phoneValidationRes, response, intPhoneNumber;
            var _a;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        emailOrPhone = (_a = formFields.find(function (field) { return field.id === "emailOrPhone"; })) === null || _a === void 0 ? void 0 : _a.value;
                    ...
                    case 4: throw new error_1.default(emailValidationRes);
                    case 5: return [3 /*break*/, 11];
                    case 6: return [4 /*yield*/, props.config.validatePhoneNumber(emailOrPhone)];
                    case 7:
                    ...
                    case 8:
                        response = _b.sent();
                        return [2 /*return*/, response];
                    case 9: return [4 /*yield*/, props.config.signInUpFeature.guessInternationPhoneNumberFromInputPhoneNumber(emailOrPhone, props.config.signInUpFeature.defaultCountry)];
                    case 10:
        ...
        }); }, validateOnBlur: false, showLabels: true, footer: (0, jsx_runtime_1.jsx)(signInUpFooter_1.SignInUpFooter, { privacyPolicyLink: props.config.signInUpFeature.privacyPolicyLink, termsOfServiceLink: props.config.signInUpFeature.termsOfServiceLink }) }));
});
//# sourceMappingURL=emailOrPhoneForm.js.map