...
var SignInUpTheme = function (_a) {
    ...
    var commonProps = {
        ...
        config: props.config,
        clearError: function () { return props.dispatch({ type: "setError", error: undefined }); },
        onError: function (error) { return props.dispatch({ type: "setError", error: error }); },
        error: featureState.error,
    };
    return activeScreen === SignInUpScreens.CloseTab ? ((0, jsx_runtime_1.jsx)(closeTabScreen_1.CloseTabScreen, __assign({}, commonProps))) : activeScreen === SignInUpScreens.LinkSent ? ((0, jsx_runtime_1.jsx)(linkSent_1.LinkSent, __assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo }))) : ((0, jsx_runtime_1.jsxs)("div", __assign({ "data-supertokens": "container", css: styles.container }, { children: [(0, jsx_runtime_1.jsx)("div", __assign({ "data-supertokens": "row", css: styles.row }, { children: featureState.loaded && ((0, jsx_runtime_1.jsxs)(react_1.default.Fragment, { children: [activeScreen === SignInUpScreens.UserInputCodeForm ? ((0, jsx_runtime_1.jsx)(userInputCodeFormHeader_1.UserInputCodeFormHeader, __assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo }))) : ((0, jsx_runtime_1.jsx)(signInUpHeader_1.SignInUpHeader, {})), featureState.error !== undefined && (0, jsx_runtime_1.jsx)(generalError_1.default, { error: featureState.error }), activeScreen === SignInUpScreens.EmailForm ? ((0, jsx_runtime_1.jsx)(emailForm_1.EmailForm, __assign({}, commonProps))) : activeScreen === SignInUpScreens.PhoneForm ? ((0, jsx_runtime_1.jsx)(phoneForm_1.PhoneForm, __assign({}, commonProps))) : activeScreen === SignInUpScreens.EmailOrPhoneForm ? ((0, jsx_runtime_1.jsx)(emailOrPhoneForm_1.EmailOrPhoneForm, __assign({}, commonProps))) : activeScreen === SignInUpScreens.UserInputCodeForm ? ((0, jsx_runtime_1.jsx)(userInputCodeForm_1.UserInputCodeForm, __assign({}, commonProps, { loginAttemptInfo: featureState.loginAttemptInfo, onSuccess: props.onSuccess }))) : null] })) })), (0, jsx_runtime_1.jsx)(SuperTokensBranding_1.SuperTokensBranding, {})] })));
};
