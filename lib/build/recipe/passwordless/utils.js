...
exports.consumeCode = exports.resendCode = exports.createCode = exports.setLoginAttemptInfo = exports.getLoginAttemptInfo = exports.defaultGuessInternationPhoneNumberFromInputPhoneNumber = exports.normalisePasswordlessConfig = void 0;
...
function normalisePasswordlessConfig(config) {
    ...
    var override = __assign({ functions: function (originalImplementation) { return originalImplementation; }, components: {} }, config.override);
    ...
    return __assign(__assign({}, (0, utils_1.normaliseAuthRecipe)(config)), { validateEmailAddress: validateEmailAddress, validatePhoneNumber: validatePhoneNumber, signInUpFeature: signInUpFeature, linkClickedScreenFeature: normalisePasswordlessBaseConfig(config.linkClickedScreenFeature), contactMethod: config.contactMethod, override: override });
}
    ...
    if (defaultCountryFromConfig !== undefined) {
        try {
            return (_a = (0, min_1.default)(value, {
                ...
                extract: false,
            })) === null || _a === void 0 ? void 0 : _a.formatInternational();
        }
        catch (_b) {
...
function getLoginAttemptInfo(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, input.recipeImplementation.getLoginAttemptInfo({
...
function setLoginAttemptInfo(input) {
    return __awaiter(this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0: return [4 /*yield*/, input.recipeImplementation.setLoginAttemptInfo({
                        userContext: input.userContext,
