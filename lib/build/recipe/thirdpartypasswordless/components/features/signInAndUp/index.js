...
var SignInAndUp = function (props) {
    var _a;
    var _b = (0, signInAndUp_1.useFeatureReducer)(), tpState = _b[0], tpDispatch = _b[1];
    var userContext = (0, usercontext_1.useUserContext)();
    var _c = (0, signInAndUp_2.useFeatureReducer)((_a = props.recipe.passwordlessRecipe) === null || _a === void 0 ? void 0 : _a.recipeImpl, userContext), pwlessState = _c[0], pwlessDispatch = _c[1];
    var _d = React.useReducer(function (state, action) {
        switch (action.type) {
            ...
            case "load":
                ...
                return __assign(__assign({}, state), { error: state.error !== undefined ? state.error : action.error });
    ...
    var combinedTPDispatch = React.useCallback(function (action) {
        dispatch(action);
        tpDispatch(action);
    }, [tpDispatch, dispatch]);
    var tpChildProps = (0, signInAndUp_1.useChildProps)(props.recipe.thirdPartyRecipe);
    var combinedPwlessDispatch = React.useCallback(function (action) {
        dispatch(action);
        pwlessDispatch(action);
    }, [pwlessDispatch, dispatch]);
    var callingConsumeCodeRef = (0, signInAndUp_2.useSuccessInAnotherTabChecker)(pwlessState, combinedPwlessDispatch, userContext);
    var pwlessChildProps = (0, signInAndUp_2.useChildProps)(props.recipe.passwordlessRecipe, combinedPwlessDispatch, pwlessState, callingConsumeCodeRef, props.history);
    ...
    return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: componentOverrides }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsThirdPartyPasswordless }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [props.children === undefined && (0, jsx_runtime_1.jsx)(signInUp_1.default, __assign({}, childProps)), props.children &&
