...
var ThirdPartyPasswordless = /** @class */ (function (_super) {
    ...
    function ThirdPartyPasswordless(config, recipes) {
        var _this = _super.call(this, (0, utils_2.normaliseThirdPartyPasswordlessConfig)(config), {
        ...
        _this.getFeatures = function () {
            ...
            if ((_this.config.passwordlessUserInput !== undefined &&
                ((_a = _this.config.passwordlessUserInput.signInUpFeature) === null || _a === void 0 ? void 0 : _a.disableDefaultUI) !== true) ||
                (_this.config.thirdpartyUserInput !== undefined &&
                    ((_b = _this.config.thirdpartyUserInput.signInAndUpFeature) === null || _b === void 0 ? void 0 : _b.disableDefaultUI) !== true)) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    component: function (prop) { return _this.getFeatureComponent("signInUp", prop); },
                };
            }
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signInUp") {
                if (props.redirectOnSessionExists !== false) {
                    return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(authWidgetWrapper_1.default, __assign({ authRecipe: _this, history: props.history }, { children: (0, jsx_runtime_1.jsx)(signInAndUp_1.default, __assign({ recipe: _this }, props)) })) })));
                }
                else {
                    return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(signInAndUp_1.default, __assign({ recipe: _this }, props)) })));
                }
            }
            else if (componentName === "linkClickedScreen") {
                if (_this.passwordlessRecipe === undefined) {
                    throw new Error("Embedding this component requires the passwordless recipe to be enabled. Please check the value of disablePasswordless in the configuration.");
                }
                return _this.passwordlessRecipe.getFeatureComponent(componentName, props);
            }
            else if (componentName === "signinupcallback") {
                if (_this.thirdPartyRecipe === undefined) {
                    throw new Error("Embedding this component requires the thirdparty recipe to be enabled. Please check the value of signInUpFeature.providers in the configuration.");
                }
        ...
        _this.passwordlessRecipe =
            recipes.passwordlessInstance !== undefined
                ...
                : _this.config.passwordlessUserInput === undefined
                    ? undefined
                    : new recipe_1.default(__assign(__assign({}, _this.config.passwordlessUserInput), { appInfo: _this.config.appInfo, recipeId: _this.config.recipeId, override: __assign(__assign({}, _this.config.passwordlessUserInput.override), { functions: function () { return (0, passwordlessImplementation_1.default)(_this.recipeImpl); } }) }));
        ...
        _this.thirdPartyRecipe =
            recipes.thirdPartyInstance !== undefined
                ...
                : _this.config.thirdpartyUserInput === undefined
                    ? undefined
                    : new recipe_2.default(__assign(__assign({}, _this.config.thirdpartyUserInput), { appInfo: _this.config.appInfo, recipeId: _this.config.recipeId, override: __assign(__assign({}, _this.config.thirdpartyUserInput.override), { functions: function () { return (0, thirdPartyImplementation_1.default)(_this.recipeImpl); } }) }), {
    ...
    ThirdPartyPasswordless.init = function (config) {
        return function (appInfo) {
            ThirdPartyPasswordless.instance = new ThirdPartyPasswordless(__assign(__assign({}, config), { appInfo: appInfo, recipeId: ThirdPartyPasswordless.RECIPE_ID }), {
