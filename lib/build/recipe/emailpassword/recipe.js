...
var EmailPassword = /** @class */ (function (_super) {
    ...
    function EmailPassword(config, recipes) {
        var _this = _super.call(this, (0, utils_2.normaliseEmailPasswordConfig)(config), {
        ...
        _this.getFeatures = function () {
            ...
            if (_this.config.signInAndUpFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    ...
                    component: function (props) { return _this.getFeatureComponent("signinup", props); },
                };
            }
            if (_this.config.resetPasswordUsingTokenFeature.disableDefaultUI !== true) {
                ...
                features[normalisedFullPath.getAsStringDangerous()] = {
                    matches: (0, utils_1.matchRecipeIdUsingQueryParams)(_this.config.recipeId),
                    component: function (props) { return _this.getFeatureComponent("resetpassword", props); },
                };
            }
        ...
        _this.getDefaultRedirectionURL = function (context) { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                if (context.action === "RESET_PASSWORD") {
                    ...
                    return [2 /*return*/, "".concat(this.config.appInfo.websiteBasePath.appendPath(resetPasswordPath).getAsStringDangerous(), "?rid=").concat(this.config.recipeId)];
                }
        ...
        _this.getFeatureComponent = function (componentName, props) {
            if (componentName === "signinup") {
                ...
                return ((0, jsx_runtime_1.jsx)(userContextWrapper_1.default, __assign({ userContext: props.userContext }, { children: (0, jsx_runtime_1.jsx)(resetPasswordUsingToken_1.default, __assign({ recipe: _this }, props)) })));
            }
            else {
    ...
    EmailPassword.init = function (config) {
        return function (appInfo) {
            EmailPassword.instance = new EmailPassword(__assign(__assign({}, config), { appInfo: appInfo, recipeId: EmailPassword.RECIPE_ID }), {
