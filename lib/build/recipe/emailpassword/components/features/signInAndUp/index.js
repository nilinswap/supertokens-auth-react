...
function useChildProps(recipe, state, dispatch, history) {
    var _this = this;
    var recipeImplementation = (0, react_2.useMemo)(function () { return recipe && getModifiedRecipeImplementation(recipe.recipeImpl); }, [recipe]);
    var userContext = (0, usercontext_1.useUserContext)();
    var onSignInSuccess = (0, react_3.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 4:
                    ...
                    return [4 /*yield*/, recipe.savePostEmailVerificationSuccessRedirectState({
                ...
                case 5:
                    _a.sent();
                    return [2 /*return*/, recipe.emailVerification.redirect({
                            action: "VERIFY_EMAIL",
                        }, history)];
                case 6: return [4 /*yield*/, recipe.redirect({
                        action: "SUCCESS",
                        isNewUser: false,
                        redirectToPath: (0, utils_1.getRedirectToPathFromURL)(),
                    }, history)];
    ...
    var onSignUpSuccess = (0, react_3.useCallback)(function () { return __awaiter(_this, void 0, void 0, function () {
        return __generator(this, function (_a) {
            switch (_a.label) {
                case 0:
                    if (!recipe) {
                ...
                case 1:
                    _a.sent();
                    return [4 /*yield*/, recipe.emailVerification.redirect({
                            action: "VERIFY_EMAIL",
                        }, history)];
                case 2: return [2 /*return*/, _a.sent()];
                case 3: return [4 /*yield*/, recipe.redirect({
                        redirectToPath: (0, utils_1.getRedirectToPathFromURL)(),
                        isNewUser: true,
                        action: "SUCCESS",
                    }, history)];
    ...
    return (0, react_2.useMemo)(function () {
        ...
        var signInForm = {
            ...
            error: state.error,
            clearError: function () { return dispatch({ type: "setError", error: undefined }); },
            onError: function (error) { return dispatch({ type: "setError", error: error }); },
            onSuccess: onSignInSuccess,
            forgotPasswordClick: function () { return recipe.redirect({ action: "RESET_PASSWORD" }, history); },
        };
        var signUpForm = {
            recipeImplementation: recipeImplementation,
            config: recipe.config,
...
var SignInAndUpFeature = function (props) {
    var _a = (0, exports.useFeatureReducer)(props.recipe), state = _a[0], dispatch = _a[1];
    var childProps = useChildProps(props.recipe, state, dispatch, props.history);
    return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: props.recipe.config.override.components }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsEmailPassword }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [props.children === undefined && ((0, jsx_runtime_1.jsx)(signInAndUp_1.default, __assign({}, childProps, { featureState: state, dispatch: dispatch }))), props.children &&
...
function getThemeSignUpFeatureFormFields(formFields, recipe, userContext) {
    ...
    return formFields.map(function (field) { return (__assign(__assign({}, field), { showIsRequired: (function () {
            ...
            return function (value) { return __awaiter(_this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        ...
                        case 2:
                            _a.trys.push([2, 4, , 5]);
                            return [4 /*yield*/, recipe.recipeImpl.doesEmailExist({
                                    email: value,
