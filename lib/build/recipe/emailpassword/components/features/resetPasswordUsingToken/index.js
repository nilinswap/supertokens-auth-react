...
var ResetPasswordUsingToken = /** @class */ (function (_super) {
    ...
    function ResetPasswordUsingToken(props) {
        ...
        _this.render = function () {
            ...
            var submitNewPasswordFormFeature = _this.props.recipe.config.resetPasswordUsingTokenFeature.submitNewPasswordForm;
            var submitNewPasswordForm = _this.state.token === undefined
                ? undefined
                : {
                    error: _this.state.error,
                    onError: function (error) { return _this.setState(function (os) { return (__assign(__assign({}, os), { error: error })); }); },
                    clearError: function () { return _this.setState(function (os) { return (__assign(__assign({}, os), { error: undefined })); }); },
            ...
            return ((0, jsx_runtime_1.jsx)(componentOverrideContext_1.ComponentOverrideContext.Provider, __assign({ value: componentOverrides }, { children: (0, jsx_runtime_1.jsx)(featureWrapper_1.default, __assign({ useShadowDom: _this.props.recipe.config.useShadowDom, defaultStore: translations_1.defaultTranslationsEmailPassword }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [_this.props.children === undefined && (0, jsx_runtime_1.jsx)(resetPasswordUsingToken_1.default, __assign({}, props)), _this.props.children &&
