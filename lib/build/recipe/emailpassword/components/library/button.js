...
function Button(_a) {
    ...
    return ((0, jsx_runtime_1.jsxs)("button", __assign({ type: type, disabled: disabled, onClick: onClick, css: styles.button, "data-supertokens": "button" }, { children: [t(label), isLoading && "..."] })));
}
