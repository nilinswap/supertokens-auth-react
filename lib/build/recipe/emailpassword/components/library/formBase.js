...
var FormBase = function (props) {
    ...
    var _a = (0, react_1.useState)(props.formFields.map(function (f) { return ({ id: f.id, value: "" }); })), fieldStates = _a[0], setFieldStates = _a[1];
    ...
    var updateFieldState = (0, react_2.useCallback)(function (id, update) {
        setFieldStates(function (os) {
            ...
            return os.filter(function (f) { return f !== field; }).concat(update(field));
        });
    }, [setFieldStates]);
    ...
    var onInputBlur = (0, react_2.useCallback)(function (field) { return __awaiter(void 0, void 0, void 0, function () {
    ...
    var onFormSubmit = (0, react_2.useCallback)(function (e) { return __awaiter(void 0, void 0, void 0, function () {
                ...
                case 5:
                    ...
                    if (generalError !== undefined) {
                        ...
                        if (result.status === "FIELD_ERROR") {
                            ...
                            setFieldStates(function (os) {
                                return os.map(function (fs) { var _a; return (__assign(__assign({}, fs), { error: (_a = errorFields_1.find(function (ef) { return ef.id === fs.id; })) === null || _a === void 0 ? void 0 : _a.error })); });
                            });
                        }
                    }
                    return [3 /*break*/, 8];
    ...
    return ((0, jsx_runtime_1.jsxs)("form", __assign({ autoComplete: "on", noValidate: true, onSubmit: onFormSubmit }, { children: [formFields.map(function (field) {
                var type = "text";
                ...
                return ((0, jsx_runtime_1.jsx)(_1.FormRow, __assign({ hasError: fstate.error !== undefined }, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [showLabels &&
                                (field.labelComponent !== undefined ? (field.labelComponent) : ((0, jsx_runtime_1.jsx)(_1.Label, { value: field.label, showIsRequired: field.showIsRequired }))), field.inputComponent !== undefined ? ((0, jsx_runtime_1.jsx)(field.inputComponent, { type: type, name: field.id, validated: fstate.validated === true, placeholder: field.placeholder, value: fstate.value, autoComplete: field.autoComplete, autofocus: field.autofocus, onInputFocus: onInputFocus, onInputBlur: onInputBlur, onChange: onInputChange, hasError: fstate.error !== undefined })) : ((0, jsx_runtime_1.jsx)(_1.Input, { type: type, name: field.id, validated: fstate.validated === true, placeholder: field.placeholder, value: fstate.value, autoComplete: field.autoComplete, onInputFocus: onInputFocus, onInputBlur: onInputBlur, onChange: onInputChange, autofocus: field.autofocus, hasError: fstate.error !== undefined })), fstate.error && (0, jsx_runtime_1.jsx)(_1.InputError, { error: fstate.error })] }) }), field.id));
            }), (0, jsx_runtime_1.jsx)(_1.FormRow, { children: (0, jsx_runtime_1.jsxs)(react_1.Fragment, { children: [(0, jsx_runtime_1.jsx)(_1.Button, { disabled: isLoading, isLoading: isLoading, type: "submit", label: buttonLabel }), footer] }) }, "form-button")] })));
};
