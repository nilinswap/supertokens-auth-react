...
export default abstract class AuthRecipeWithEmailVerification<T, R, N extends NormalisedConfig<T | GetRedirectionURLContext, PreAndPostAPIHookAction, R | OnHandleEventContext>> extends AuthRecipe<T | GetRedirectionURLContext, PreAndPostAPIHookAction, R | OnHandleEventContext, N> {
    emailVerification: EmailVerification;
    constructor(config: N, recipes: {
