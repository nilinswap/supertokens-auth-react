import { UserInputForAuthRecipeModule as EmailVerificationUserInput, GetRedirectionURLContext as EmailVerificationGetRedirectionURLContext, OnHandleEventContext as EmailVerificationOnHandleEventContext, PreAPIHookContext as EmailVerificationPreAPIHookContext, PreAndPostAPIHookAction as EmailVerificationPreAndPostAPIHookAction, ComponentOverrideMap as EmailVerificationComponentOverrideMap } from "../emailverification/types";
...
export declare type Config<T, PreAndPostAPIHookAction, R> = UserInput<T, PreAndPostAPIHookAction, R> & AuthRecipeType.Config<T, PreAndPostAPIHookAction, R>;
...
export declare type GetRedirectionURLContext = AuthRecipeType.GetRedirectionURLContext | EmailVerificationGetRedirectionURLContext;
