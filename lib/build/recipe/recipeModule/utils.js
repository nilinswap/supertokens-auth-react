...
function normaliseRecipeModuleConfig(config) {
    ...
    return __assign(__assign({}, config), { getRedirectionURL: getRedirectionURL, onHandleEvent: onHandleEvent, preAPIHook: preAPIHook, postAPIHook: postAPIHook, useShadowDom: useShadowDom, palette: palette, rootStyle: rootStyle, recipeId: config.recipeId, appInfo: config.appInfo });
}
