...
var TranslationContextProvider = function (_a) {
    ...
    var _b = (0, react_1.useState)(defaultStore), translationStore = _b[0], setTranslationStore = _b[1];
    var _c = (0, react_1.useState)(undefined), currentLanguage = _c[0], setCurrentLanguage = _c[1];
        ...
        function loadLanguageFromCookies() {
            return __awaiter(this, void 0, void 0, function () {
                ...
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, (0, translationHelpers_1.getCurrentLanguageFromCookie)()];
                        case 1:
                            cookieLang = _a.sent();
    ...
    (0, react_1.useEffect)(function () {
        ...
        var loadHandler = function (_eventName, detail) {
            setTranslationStore(function (os) { return (0, utils_1.mergeObjects)(os, detail); });
        };
    ...
    var translateFunc = (0, react_1.useCallback)(function (key) {
    ...
    return (0, jsx_runtime_1.jsx)(exports.TranslationContext.Provider, __assign({ value: { translate: translateFunc } }, { children: children }));
};
