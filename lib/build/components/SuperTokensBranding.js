...
function SuperTokensBranding() {
    ...
    return ((0, jsx_runtime_1.jsxs)("a", __assign({ "data-supertokens": "superTokensBranding", css: styles.superTokensBranding, href: "https://supertokens.com?utm_campaign=poweredby", target: "_blank" }, { children: [t("BRANDING_POWERED_BY_START"), (0, jsx_runtime_1.jsx)("strong", { children: "Noone" }), t("BRANDING_POWERED_BY_END")] })));
}
