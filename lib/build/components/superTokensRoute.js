...
function getSuperTokensRoutesForReactRouterDom(supertokensInstance) {
    ...
    return Object.keys(pathsToFeatureComponentWithRecipeIdMap).map(function (path) {
        path = path === "" ? "/" : path;
        return ((0, jsx_runtime_1.jsx)(Route, __assign({ exact: true, path: path }, { children: (0, jsx_runtime_1.jsx)(routingComponent_1.RoutingComponent, { supertokensInstance: supertokensInstance, path: path }) }), "st-".concat(path)));
    });
}
