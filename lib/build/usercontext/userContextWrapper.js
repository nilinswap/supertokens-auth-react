...
function UserContextWrapper(props) {
    ...
    if (props.userContext !== undefined) {
        return (0, jsx_runtime_1.jsx)(_1.UserContextProvider, __assign({ userContext: props.userContext }, { children: props.children }));
    }
    return ((0, jsx_runtime_1.jsx)(_1.UserContextContext.Consumer, { children: function (value) {
            /**
...
//# sourceMappingURL=userContextWrapper.js.map